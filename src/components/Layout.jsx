...
const NAV_ITEMS = [
  ...
  // Media→content matcher worklist (Phase P0) — drafts still needing a photo/
  // video. Ungated like Library so producers (no interview.start) see it; it's
  // exactly their surface.
