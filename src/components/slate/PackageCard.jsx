        ...
        {!showGenerating && !isFailed && (
          <>
            <div className="absolute top-2 left-2 flex gap-1 flex-wrap">
              {pkg.broll_status === 'complete' ? (
                <span
                  className="inline-flex items-center gap-1 rounded-md px-1.5 py-0.5 text-3xs font-bold text-white bg-amber-500/80 backdrop-blur-sm"
                  title="Footage generated by Runway AI — no matching real clips were found for this topic"
                >
