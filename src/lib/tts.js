...
/** @typedef {{ onStart?: () => void; onEnd?: () => void; onError?: (e: unknown) => void; voiceId?: string; speed?: number }} SpeakOptions */
  ...
  async function speak(text, opts = {}) {
    ...
    try {
      res = await apiFetchResponse('/api/tts', {
        ...
        body: JSON.stringify({ text, voiceId: opts.voiceId, speed: opts.speed }),
        signal,
      })
    } catch {
