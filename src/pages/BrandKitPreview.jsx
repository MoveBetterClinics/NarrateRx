        ...
        <div className="max-w-6xl mx-auto px-6 py-2 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-1 text-xs">
            <button
              ...
              className={`px-2 py-1 rounded-md transition-colors ${variant === 'settings' ? 'bg-amber-200 dark:bg-amber-900 font-semibold' : 'hover:bg-amber-100 dark:hover:bg-amber-900/50'}`}
            >Settings variant</button>
            <button
              onClick={() => setVariant('onboarding')}
              className={`px-2 py-1 rounded-md transition-colors ${variant === 'onboarding' ? 'bg-amber-200 dark:bg-amber-900 font-semibold' : 'hover:bg-amber-100 dark:hover:bg-amber-900/50'}`}
