...
import {
  FileText, Clock, CalendarDays,
  ChevronRight,
  AlertCircle, Loader2, RefreshCw,
  ThumbsUp, Archive, ArchiveRestore, Trash2,
} from 'lucide-react'
...
import {
  PLATFORM_META, STATUS_META, STATUS_TABS, PLATFORM_GROUPS,
} from '@/lib/contentMeta'

// (Constants moved to @/lib/contentMeta. A back-compat re-export lives at
// the bottom of the file so any remaining `import { PLATFORM_META } from
// '@/pages/ContentHub'` call sites keep working until they migrate.)
...
export { PLATFORM_META, STATUS_META, STATUS_TABS, PLATFORM_GROUPS }
