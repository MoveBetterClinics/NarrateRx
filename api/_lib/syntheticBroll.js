 ...
 */
async function uploadGeneratedVideo({ videoUrl, workspace, staffId, topic }) {
 ...
 * @param {string|null} opts.staffId  — optional clinician for asset attribution
 * @param {string[]} opts.channels        — video channels to render (e.g. ['linkedin_video'])
 * @param {string} opts.staffName     — display name for caption overlays
 */
