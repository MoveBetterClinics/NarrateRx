...
export default async function handler(req, res) {
  ...
  query += `&select=id,topic,caption_text,similarity,channels,renders,status,error_message,created_at,source_asset_id,clinician_id,voice_fidelity_score,voice_fidelity_breakdown,source_asset:media_assets(consent_status,consent_notes)`
