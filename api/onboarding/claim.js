...
export default async function handler(req, res) {
  ...
  return res.status(200).json({
    ...
    // New tenants land on Dashboard with the getting-started checklist
    // rather than the (large) Workspace Settings page. They can still reach
    // Settings from the Workspace icon in the chrome.
